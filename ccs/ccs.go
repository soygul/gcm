...
func (c *Conn) Receive() (*InMsg, error) {
	...
	if chat.Type == "error" {
		// todo: once go-xmpp can parse XMPP error messages, return error with XMPP error message (issue: https://github.com/titan-x/gcm/issues/14)
